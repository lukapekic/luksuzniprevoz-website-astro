...
| --------------------- | ----------------------------------- | -------------------------------------------------------- | ------------------------------------------ | --------------------------------------------------------------------------- | ------------------------------------------------------------- |
| Hero                  | Blueprint §6                        | service data + localized Hero + shared image             | `ServiceHero / full-bleed`                 | full-bleed viewport-minimum canvas with over-Hero Header at every state     | component tests, five-state render, page verification         |
