...
overview:
  heading:
    title: "What we organise for the wedding day"
    intro: "Wedding transportation can mean one principal vehicle for the couple or a wider plan connecting family, guests and several important times."
  body: "Send the date, locations, approximate times and passenger count. We align suitable vehicles and the transport organisation with the request, then confirm the final plan after checking availability."
  items:
    - "Chauffeur-driven transportation for the couple according to the agreed schedule."
    - "Family and guest transportation when included in the confirmed wedding plan."
    - "One or several vehicles, with waiting and return transport only when arranged and confirmed in advance."
...
sections:
  - key: serviceScope
    ...
    items:
      ...
      - title: "Additional vehicles and guests"
        text: "Additional vehicles can be organised for family and guests when the wedding plan requires them."
      - title: "Waiting and return"
        text: "Waiting and return transportation are included in the request and confirmed as part of the specific arrangement."
  ...
  - key: weddingDay
    ...
    items:
      ...
      - title: "Ceremony"
        text: "Arrival according to the time and location included in your plan."
      - title: "Photography or another planned location"
        text: "An additional planned stop can be part of the schedule when it is included in advance."
      - title: "Celebration"
        text: "Transportation continues to the restaurant, hotel or another confirmed celebration location."
      - title: "Agreed return"
        text: "Return transportation is organised when it has been included and confirmed in advance."
  ...
  - key: guestTransport
    ...
    items:
      ...
      - title: "Family and smaller groups"
        text: "An additional vehicle can connect family members or a smaller guest group with the agreed locations."
      - title: "Larger groups"
        text: "For a larger number of guests, suitable group vehicles or several vehicles are reviewed as part of the plan."
  ...
  - key: process
    heading:
      title: "From your wedding plan to confirmed transportation"
      intro: "Three clear steps are enough to start the organisation."
    items:
      - title: "Send the plan"
...
faq:
  heading: "Frequently asked questions about wedding transportation"
  items:
