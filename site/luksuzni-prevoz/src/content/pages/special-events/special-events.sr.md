...
overview:
  heading:
    title: "Prevoz prema putnicima i toku događaja"
    intro: "Važan dolazak i prevoz gostiju mogu biti deo istog dogovora."
...
sections:
  ...
  - key: serviceScope
    ...
    body: "Ne morate unapred znati koliko vozila vam je potrebno. Pošaljite osnovni raspored i broj putnika, a organizaciju definišemo prema izabranoj usluzi i potvrđenoj raspoloživosti."
    items:
...
vehicleRecommendations:
  heading:
    ...
    intro: "Vozilo biramo prema putnicima, ulozi u događaju i raspoloživosti za traženi datum."
  vehicleIds:
    - mercedes-s-class
    - mercedes-e-class
...
faq:
  ...
  items:
    ...
    - question: "Da li je rezervacija potvrđena odmah nakon slanja zahteva?"
      answer: "Ne. Tim proverava datum, raspoloživost vozila, raspored i detalje organizacije, a zatim ručno potvrđuje organizaciju."

finalCta:
  heading: "Pošaljite datum i plan. Mi ćemo predložiti prevoz."
  text: "Pošaljite datum, lokacije, okvirno vreme, broj putnika i vrstu prilike. Ako niste sigurni koje vozilo da izaberete, prepustite preporuku našem timu."
  primaryCta:
