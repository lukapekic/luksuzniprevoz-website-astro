...
overview:
  ...
  items:
    ...
    - "One vehicle or several coordinated movements when the schedule and passenger requirements call for them."
...
sections:
  - key: serviceScope
    ...
    items:
      ...
      - title: "Private itinerary"
        text: "Several planned movements can be coordinated around hotels, meetings, restaurants, events and other confirmed locations."
      - title: "Multiple vehicles"
        text: "Additional vehicles can form part of the same arrangement when accompanying guests or separate passenger groups need their own transportation."
  ...
  - key: aviation
    ...
    items:
      ...
      - title: "Private aviation"
        text: "Ground transportation for private aviation passengers is organised individually according to the confirmed request and operational possibilities."
      - title: "Onward itinerary"
        text: "The arrival does not have to remain a separate journey — subsequent confirmed locations can form part of the same coordinated engagement."
    cta:
      label: "Discuss an arrival"
      target:
        type: flow
        flowKey: booking
  ...
  - key: itinerary
    ...
    items:
      - title: "Arrival"
        text: "The first confirmed pickup or aviation arrival establishes the beginning of the engagement."
      - title: "Scheduled movements"
        text: "Hotels, meetings, private engagements, restaurants and events are connected according to the confirmed itinerary."
      - title: "Additional passengers or vehicles"
        text: "Separate vehicles can be included when accompanying passengers or the schedule require a different transport arrangement."
      - title: "Changes"
        text: "Schedule changes are reviewed against the confirmed engagement, reserved resources and current availability."
      - title: "Dedicated coordination"
        text: "For more complex bookings, coordination aligns the relevant vehicles, passengers and timings within one operating plan."
...
faq:
  heading: "Frequently asked questions about VIP Transportation"
  items:
