...
sections:
  - key: audience
    ...
    items:
      - {
          title: "Diplomatic missions and embassies",
          text: "For guest and delegation transportation where professional presentation, scheduling and discretion carry particular importance.",
        }
      - {
          title: "Official and institutional delegations",
          text: "For visits where several members need to be coordinated across one programme and confirmed movements.",
        }
      - {
          title: "International organisations",
          text: "For guests, representatives and teams requiring organised transportation between programme locations.",
        }
      - {
          title: "Corporate and executive delegations",
          text: "For executives, partners and business groups that use different vehicles or move separately during a visit.",
        }
      - {
          title: "Hosts, assistants and coordinators",
          text: "For the people managing the programme who want one transport coordination point instead of several disconnected bookings.",
        }
...
faq:
  ...
  items:
    - {
        question: "Can you organise multiple vehicles for one delegation?",
    ...
    - {
        question: "Does Delegation Transportation include security or protection services?",
