...
sections:
  - key: audience
    ...
    items:
      ...
      - {
          ...
          text: "Za goste, predstavnike i timove kojima je potreban organizovan transport između tačaka programa.",
        }
      - {
      ...
      - {
          ...
          text: "Za osobe koje vode program i žele jednu tačku za organizaciju transporta umesto niza nepovezanih rezervacija.",
        }
  ...
  - key: mixedFleet
    ...
    items:
      - {
          title: "Reprezentativni sedan",
          text: "Za pojedinačnog rukovodioca ili člana delegacije kojem odgovara individualno kretanje i viši nivo reprezentativnosti.",
        }
      - {
          title: "Poslovni sedan",
...
faq:
  ...
  items:
    ...
    - {
        question: "Da li je uključena posvećena koordinacija prevoza?",
        answer: "{coordinatorAnswer}",
      }
    - {
        question: "Koje podatke treba da pošaljem za pripremu ponude?",
        answer: "Pošaljite datume i vremena, potvrđene ili planirane lokacije, broj putnika, strukturu grupa, željena vozila i sve posebne operativne ili zahteve poverljivosti koji utiču na organizaciju.",
      }
    - {
    ...
    - {
        question: "Možemo li zahtevati NDA ili drugi formalni uslov poverljivosti?",
        answer: "{ndaAnswer}",
      }
