...
sections:
  - key: audience
    ...
    items:
      ...
      - { title: "Assistants and travel coordinators", text: "For people managing the schedule who want one clear arrangement instead of several disconnected journeys." }
      - { title: "Companies with recurring needs", text: "For organisations where corporate transportation is not a one-off request but part of regular business operations." }
      - { title: "Working days across several locations", text: "For schedules that connect meetings, offices, hotels and other business points within the same day." }
...
faq:
  heading: "Frequently asked questions about Corporate Transportation"
  items:
    - { question: "Who is Corporate Transportation for?", answer: "The service is designed for companies, executives, business guests and people coordinating business travel. It is particularly useful when transportation needs to fit into a defined business schedule." }
    - { question: "Can I send a single corporate transportation request?", answer: "{oneOffAnswer}" }
    - { question: "Do you support recurring corporate arrangements?", answer: "{recurringAnswer}" }
    - { question: "Are invoicing and negotiated commercial terms available?", answer: "{commercialAnswer}" }
    - { question: "Can the same chauffeur stay across several connected stops?", answer: "{dedicatedAnswer}" }
    - { question: "What details should I send with a corporate request?", answer: "Send the date, time, locations, passenger count and the basic structure of the schedule. For a recurring requirement, also include the expected frequency so the team can assess the appropriate arrangement." }
    - { question: "Do you arrange corporate transportation outside Belgrade?", answer: "{outsideAreaAnswer}" }
    - { question: "Can I choose a specific vehicle?", answer: "{vehicleAnswer}" }
