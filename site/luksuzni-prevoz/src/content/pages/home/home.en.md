...
services:
  heading:
    ...
    intro: "From a single ride to coordinated multi-vehicle transport, choose the service that fits your schedule."
  items:
...
reviews:
  heading:
    ...
    intro: "See customer feedback on our Google profile."
